...
const schema23 = {"title":"Node","$id":"#node","type":"object","required":["publicKey","quorumSet","countryCode","isp"],"properties":{"publicKey":{"$id":"#node/publicKey","title":"Publickey","type":"string","default":"","examples":["GCGB2S2KGYARPVIA37HYZXVRM2YZUEXA6S33ZU5BUDC6THSB62LZSTYH"],"pattern":"^.*$"},"quorumSet":{"$ref":"#/definitions/quorumSet"},"countryCode":{"$id":"#node/countryCode","title":"Country code","type":"string","default":"","examples":["SG"],"pattern":"^.*$"},"isp":{"$id":"#node/isp","title":"Isp","type":"string","default":"","examples":["Digitalocean LLC"],"pattern":"^.*$"}}};
...
if(data && typeof data == "object" && !Array.isArray(data)){
let missing0;
if((((data.publicKey === undefined && (missing0 = "publicKey")) || (data.quorumSet === undefined && (missing0 = "quorumSet"))) || (data.countryCode === undefined && (missing0 = "countryCode"))) || (data.isp === undefined && (missing0 = "isp"))){
...
let data2 = data.countryCode;
const _errs4 = errors;
if(errors === _errs4){
if(typeof data2 === "string"){
if(!pattern0.test(data2)){
validate21.errors = [{keyword:"pattern",dataPath:dataPath+"/countryCode",schemaPath:"#/properties/countryCode/pattern",params:{pattern: "^.*$"},message:"should match pattern \""+"^.*$"+"\""}];
return false;
}
}
else {
validate21.errors = [{keyword:"type",dataPath:dataPath+"/countryCode",schemaPath:"#/properties/countryCode/type",params:{type: "string"},message:"should be string"}];
return false;
}
}
