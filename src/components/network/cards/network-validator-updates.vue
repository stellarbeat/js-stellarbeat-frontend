        ...
        <div v-bind:class="dimmerClass">
            ...
            <div class="dimmer-content">
                <b-list-group v-if="!isLoading" flush class="w-100 mb-4  card-columns">
                    <b-list-group-item v-for="snapshot in snapshots" :key="snapshot.node.publicKey + snapshot.startDate" class="px-3 py-2">
                        ...
                        <div class="d-flex align-items-center ml-2">
                            <div class="mr-1">
                                <router-link
                                        :to="{ name: 'node-dashboard', params: { publicKey: snapshot.node.publicKey }, query: {network: $route.query.network, 'at': $route.query.at}}">
