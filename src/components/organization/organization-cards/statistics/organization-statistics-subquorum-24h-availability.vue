<template>
    <div class="card">
        <div class="card-body d-flex flex-row flex-wrap align-items-center p-3">
            ...
            class="mr-3"/>
            <div class="lh-sm">
                <div class="strong"> {{+organization.subQuorum24HoursAvailability.toFixed(2)}}%</div>
                <div class="text-muted">24H Availability <b-icon-info-circle class="text-gray" v-b-tooltip:hover="'Availability: more than or equal to 50% of the organization validators are validating.'"/></div>
            </div>
        </div>
    </div>
</template>
